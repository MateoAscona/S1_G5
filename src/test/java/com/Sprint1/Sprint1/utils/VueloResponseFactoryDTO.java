...
public class VueloResponseFactoryDTO {
    ...
    public static VueloResponseDto getVueloResponseFinal() {

        return VueloResponseDto.builder()
                .id(1)
                .userName("Cristian")
                .total(6500.0)
                .vuelosReservationData(getReservaResponseFinal())
                .build();
    ...
    public static VuelosReservationData getReservaResponseFinal() {
        return VuelosReservationData.builder()
                .id(1)
                .fechaDesde(LocalDate.of(2022, 02, 10))
                .fechaHasta(LocalDate.of(2022, 02, 15))
